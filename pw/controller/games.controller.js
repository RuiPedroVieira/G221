...
function read(req, res) {
    ...
    connect.con.query('SELECT * from player, room, space, user_profile, register where register.id_register=room.id_register and player.id_player=register.id_player and space.id_space=room.id_space and player.id_user_profile=user_profile.id_user_profile; ', function (err, rows, fields) {
        if (!err) {
